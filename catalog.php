    ...
    <div class="categories">
      ...
      <div class="small-container">
        ...
        <div class="row">
          ...
          <?php endforeach ?>
          <div class="d-flex justify-content-center m-auto"><a href="console.php" class="text-center"><button id="explore-cons">Explore Consoles</button></a></div>
        </div>
      </div>
      ...
      <div class="small-container">
        ...
        <div class="row">
          ...
          <?php endforeach ?>
          <div class="d-flex justify-content-center m-auto"><a href="games.php" class="text-center"><button type="button" id="explore-games">Explore Games</button></a></div>
        </div>
        ...
        <div class="row">
          ...
          <?php endforeach ?>
          <div class="d-flex justify-content-center m-auto"><a href="accessories.php" class="text-center"><button id="explore-accs">Explore Accessories</button></a></div>
        </div>
